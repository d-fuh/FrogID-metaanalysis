...
## a)	The Questions and the Hypotheses tested
...
### Step 3. Data reorganisation for Question 1, Part D & F ***TO BE EDITED; USING LINEAR REGRESSION INSTEAD***
...
***TO BE EDITED; USING LINEAR REGRESSION INSTEAD -- END***
...
ggsave("distribution_of_ecoregions_frogID.png", width = 6, height = 4)

Figure_4
```

Note that there are exactly 7 non-trivial types of ecoregions in FrogID. Notice also there is evident under-representation in the groups "Montane Grasslands & Shrublands" and "Tropical & Subtropical Moist Broadleaf Forests" (n=x and n=y respectively; mean ss=?).
...
ggsave("box_plot_nspecies_ecoregion_frogID.png", width = 6, height = 4)
...
ggsave("violin_plot_nspecies_ecoregion_frogID.png", width = 6, height = 4)
...
htmlwidgets::saveWidget(violin_plot_frogID, file="violin_plot_frogID.html")
```
...
ggsave("scatter_plot_frogID.png", width = 6, height = 4)
...
### Question 1: Independent samples t-test ***TO BE EDITED***
